...
pub struct NerdFontIconPlugin {
    ...
    dir_name_to_icon_name_map: AHashMap<&'static str, &'static str>,
...
impl NerdFontIconPlugin {
    ...
    pub fn new() -> Self {
        ...
        let dir_name_to_icon_name_map: AHashMap<&'static str, &'static str> =
    ...
    fn handle_dir(
        ...
        match self.dir_name_to_icon_name_map.get(name) {
            None => "default_folder",
...
impl IconPlugin for NerdFontIconPlugin {
    fn get_icon(
        ...
        let icon_name = match tree_line_type {
            TreeLineType::Dir => self.handle_dir(&name.to_ascii_lowercase()),
            TreeLineType::BrokenSymLink(_) => "symlink_type_broken",
            TreeLineType::SymLink { final_is_dir: true, .. } => "symlink_type_folder",
            TreeLineType::SymLink { final_is_dir: false, .. } => "symlink_type_file",
